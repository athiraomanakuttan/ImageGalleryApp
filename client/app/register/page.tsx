  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-900 via-teal-800 to-cyan-900 p-4">
      <div className="bg-slate-800 bg-opacity-95 backdrop-blur-lg rounded-3xl shadow-2xl p-10 w-full max-w-md border border-emerald-400/30">
        ...
        <p className="text-slate-400 text-center mb-8">Create your account and start capturing memories</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="phone" className="block text-sm font-semibold text-emerald-300">
              Phone Number
            </label>
            <input
              id="phone"
        ...
        <div className="mt-8 text-center">
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-slate-800 px-4 text-xs text-slate-500">TERMS</span>
            </div>
          </div>
